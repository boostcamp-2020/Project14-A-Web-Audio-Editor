      ...
      this.innerHTML = `
              <div id="editor-menu">
                <div class="icon-wrap">
                  ...
                  <audi-icon-button id="save" class="delegation" icontype="save" size="32px" event-key=${EventKeyType.EDITOR_MENU_OPEN_DOWNLOAD_BTN_CLICK}></audi-icon-button>
                </div>
                ...
                <div id="user-menu" class="icon-wrap">
                  <audi-icon-button icontype="user" size="32px"></audi-icon-button>
                  <audi-icon-button icontype="menu" size="32px"></audi-icon-button>
                </div>
              </div>
            `;
    }
